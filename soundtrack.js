...
function onPlayerStateChange(event) {
    // --- 1. TU L��GICA DE SINCRONIZACI��N (Intacta) ---
    ...
    // --- 2. ACTUALIZACI��N DE ESTADOS (Para que el bot��n lata o no) ---
...
// Si el bot��n est�� latiendo (isMusicPlaying) pero YouTube se colg�� (Error 503 o AdBlock),
// este peque?o bloque intenta despertarlo cada 20 segundos.
setInterval(() => {
    if (isMusicPlaying && player && isPlayerReady) {
        const state = player.getPlayerState();
        // Si deber��a sonar pero est�� en pausa (2) o buffering eterno (3)
